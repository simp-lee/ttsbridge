...
func TestVoiceBasicFields(t *testing.T) {
	v := Voice{
		ID:       "test-id",
		Name:     "测试语音",
...
func TestVoiceSupportsMultipleLanguages(t *testing.T) {
	v := Voice{
		ID:        "multi-lang-voice",
		Name:      "多语言测试",
		Language:  LanguageZhCN,
...
func TestVoiceExtra(t *testing.T) {
	extra := &testExtra{
		Status: "GA",
...
func TestVoiceExtraNil(t *testing.T) {
	v := Voice{
		ID:       "no-extra",
		Name:     "无Extra",
		Language: LanguageZhCN,
...
func TestVoiceSupportsLanguage(t *testing.T) {
	v := Voice{
		ID:        "test-voice",
		Name:      "测试语音",
		Language:  LanguageZhCN,
...
func TestVoiceSupportsLanguage_RejectsInvalidPrefixes(t *testing.T) {
	v := Voice{
		ID:        "test-voice",
		Name:      "测试语音",
		Language:  LanguageEnUS,
		Languages: []Language{LanguageEnUS, LanguageZhCN},
		Gender:    GenderFemale,
		Provider:  "test",
	}

	for _, lang := range []string{"e", "z", "en-", "zh-", "en--US"} {
		if v.SupportsLanguage(lang) {
			t.Fatalf("SupportsLanguage(%q) = true, want false", lang)
		}
	}

	if !v.SupportsLanguage("en") {
		t.Fatal("SupportsLanguage(\"en\") = false, want true")
	}
}

func TestVoiceJSONRoundTrip(t *testing.T) {
	extra := &testExtra{
		Status: "GA",
...
func TestVoiceJSONOmitsNilExtra(t *testing.T) {
	v := Voice{
		ID:       "test-omit",
		Name:     "省略测试",
		Language: LanguageZhCN,
...
func TestVoiceAcrossProviders(t *testing.T) {
	voices := []Voice{
		{
			ID:       "edge-1",
			Name:     "Edge语音",
